...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		OwnerId:        getEnvInt64("OWNER_ID", 8457570997),
		LoggerId:       getEnvInt64("LOGGER_ID", -1003050115861),
		...
		SupportGroup:   getEnvStr("SUPPORT_GROUP", "https://t.me/pallavisarkaar"),
		SupportChannel: getEnvStr("SUPPORT_CHANNEL", "https://t.me/shayrirahulki"),
